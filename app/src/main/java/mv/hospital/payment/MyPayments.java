...
public class MyPayments extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getExtras() != null) {
            ((EditText) findViewById(R.id.editTextEmail)).setText(intent.getStringExtra("email"));
            ((EditText) findViewById(R.id.editTextAmount)).setText(intent.getStringExtra("amount"));
...
//                            getString(R.string.use_live_key_in_production_environment), Toast.LENGTH_SHORT).show();
...
//                    ((EditText) findViewById(R.id.editTextMerchantSalt)).setText("eCwWELxi");
    ...
    public void navigateToBaseActivity() {
        ...
        mPaymentParams.setProductInfo("Products");
        mPaymentParams.setFirstName(name);
        mPaymentParams.setEmail(email);
        mPaymentParams.setPhone(mobileNumber);
    ...
    protected void onActivityResult(int requestCode, int resultCode, final Intent data) {
        if (requestCode == PayuConstants.PAYU_REQUEST_CODE) {
            if (data != null) {
                ...
                TxnPojo txnPojo = new Gson().fromJson(  data.getStringExtra("result"),TxnPojo.class);
                intent.putExtra("id",txnPojo.getTxnid());
                intent.putExtra("status",txnPojo.getStatus());
                intent.putExtra("amount",txnPojo.getAmount());
